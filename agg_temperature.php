...
<h1> Welcome! </h1>
<p> You are viewing the aggregate temperature tool for station number 
...
<form   action="agg_temperature.php" method="get" id="form2">
	 <div class='Ta'>
	 <div class='Ro'>
	 <div class='Ce'>
...
if (!$conn) {
  ...
  echo "<img src=\"jpgraph/graph_temperature.php?station_id=$station_id&year_from=$yf&year_to=$yt&month_from=$mf&month_to=$mt\">";
} 
