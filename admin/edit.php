...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	$b="UPDATE admin SET name='".$_POST['Firstname']."', email='".$_POST['email']."', Contact=".$_POST['Contact']." WHERE user_name='$user'";
	echo $b;
...
$query_Recordset1 = "SELECT user_name, name, email, contact FROM admin where user_name='$user'";
