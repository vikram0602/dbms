  ...
  <table align>
    ...
    <tr valign="baseline">
      ...
      <td valign="baseline"><table>
        <tr>
          <td align="justify"><input type="radio" name="Gender" value="male"  <?php if (!(strcmp(htmlentities($row_Recordset1['Gender'], ENT_COMPAT, 'utf-8'),"Male"))) {echo 'checked="checked"';} ?> />
            Male</td>
        </tr>
        <tr>
          <td align="justify"><input type="radio" name="Gender" value="female" <?php if (!(strcmp(htmlentities($row_Recordset1['Gender'], ENT_COMPAT, 'utf-8'),"Female"))) {echo 'checked="checked"';} ?> />
            Female</td>
        </tr>
      </table></td>
    </tr>
...
<form action="change_pass.php" method="post" name="form3" id="form3">
  <table >
