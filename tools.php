...
<input type="submit" value="Aggregate Temperature Tool">
</form>
<form action="agg_humidity.php" method="get">
<input type="hidden" name="station_id" value="<?php echo $_GET["station_id"]; ?>">
<input type="submit" value="Aggregate Humidity Tool">
</form>
<form action="agg_rainfall.php" method="get">
<input type="hidden" name="station_id" value="<?php echo $_GET["station_id"]; ?>">
<input type="submit" value="Aggregate Rainfall Tool">
</form>
<form action="agg_pressure.php" method="get">
<input type="hidden" name="station_id" value="<?php echo $_GET["station_id"]; ?>">
<input type="submit" value="Aggregate Pressure Tool">
</form>
<form action="agg_wind.php" method="get">
<input type="hidden" name="station_id" value="<?php echo $_GET["station_id"]; ?>">
<input type="submit" value="Aggregate Wind Tool">
</form>
