...
<form   action="predict_humidity.php" method="get" id="form2">
	 <div class='Ta'>
	 <div class='Ro'>
	 <div class='Ce'>
...
if (!$conn) {
  ...
  echo "<img src=\"jpgraph/graph_humidity_jan.php?station_id=$station_id&year_from=$yf&year_to=$yt&month_from=$mf&month_to=$mt&ms=$ms&predict_years=$predict_years\">";
} 
