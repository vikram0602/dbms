...
$temp_agg_b="SELECT avg(humidity) as tmp,to_char(time_stamp,'MM') as dte from climate_data where station_id=:station_id group by TO_CHAR(time_stamp,'MM') order by dte asc";
