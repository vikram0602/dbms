			...
			<!-- Header -->
				<div id="header">
					<div class="container">
						...
						<!-- Logo -->
							<h1><a href="index.php" id="logo">CSED!</a></h1>
			...
			<!-- Banner -->
				<div id="banner">
					<section class="container">
						<h2>Yantra....</h2><i><h1>an indivisible learner</i></h1>
						<span>Get Excited to Learn Bin Packing!</span>
						<form role="form" action="pre_search.php" method="post">
						<input type="text" class="form-control" name="city" id="email" placeholder=" Enter your Name....." >
						</form>
						<p></p>
					</section>
				</div>
