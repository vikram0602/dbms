...
<form   action="tool.php" method="get" id="form2">
...
include_once("config.php");
   ...
   if ($conn)
   {
       ...
       //echo "Connected to foo";
		 ...
		 $b="SELECT * from Climate_data where station_id='".$msid."and temperature >= ".$tem."and time_stamp BETWEEN TO_DATE ('$yf/$mf/01', 'yyyy/mm/dd')
